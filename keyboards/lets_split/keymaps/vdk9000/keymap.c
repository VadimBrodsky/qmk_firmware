 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  GUI |      | Alt  |Lower |Space |Space |Raise |Leader|      |      |Enter |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = KEYMAP( \
...
[_LOWER] = KEYMAP( \
  ...
  LCTL(KC_A), KC_CIRC, KC_AMPR, KC_ASTR, KC_LCBR, KC_RCBR, KC_HOME, KC_PGDOWN, KC_PGUP,    KC_END,  _______, KC_PIPE, \
  KC_PLUS,    KC_MINS, KC_UNDS, KC_EQL,  KC_LBRC, KC_RBRC, _______, _______,   _______,    _______, _______, _______, \
