...
[_QWERTY] = KEYMAP( \
  ...
  KC_LCTL, KC_LGUI, TG(_MOUSE), KC_LALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEAD, _______, _______, KC_ENT   \
),
 ...
 */
[_MOUSE] = KEYMAP( \
  KC_BTN2, KC_WH_U, KC_MS_U, KC_WH_D, _______, _______, _______, _______, _______, _______, _______, _______, \
