 ...
 * |------+------+------+------+------+------|      ,---------------------------.      |------+------+------+------+------+------|
 * | Tab  |   A  |   S  |   D  |   F  |   G  |      |  Ctl |  GUI |      |Leader|      |   H  |   J  |   K  |   L  |   ;  |  '   |
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
 ...
 */
  [_QWERTY] = KEYMAP( \
    ...
    KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,             KC_LCTL, KC_LGUI, _______, KC_LEAD,          KC_H,    KC_J,    KC_K,    KC_L,      KC_SCLN, KC_QUOT, \
 ...
 */
  [_RAISE] = KEYMAP( \
    ...
    KC_LCBR, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY, KC_BSLS, KC_RCBR  \
  ),
